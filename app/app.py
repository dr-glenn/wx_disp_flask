...
# These route requests are usually generated by clicking a button on the display.
# The Request params are attached to the buttons.
# See make_buttons in OpenWeatherProvider.py
